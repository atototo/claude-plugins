...
const instruction = [
  ...
  "   - Agent(subagent_type='ai-party:architect', team_name=<위 team_name>, name='architect', description='Architecture design worker', mode='bypassPermissions', model='opus', max_turns=15, prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:builder', team_name=<위 team_name>, name='builder', description='Implementation builder worker', mode='bypassPermissions', model='sonnet', max_turns=8, prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:analyst', team_name=<위 team_name>, name='analyst', description='Analysis and scanning worker', mode='bypassPermissions', model='sonnet', max_turns=8, prompt='<role info>')",
