...
const instruction = [
  ...
  "   - Agent(subagent_type='ai-party:leader-agent', team_name=<위 team_name>, name='leader', mode='bypassPermissions', prompt='<아래 Leader prompt 규칙 참고>')",
  ...
  "   - Agent(subagent_type='ai-party:claude-agent', team_name=<위 team_name>, name='claude-architect', mode='bypassPermissions', max_turns=15, prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:codex-agent', team_name=<위 team_name>, name='codex-builder', mode='bypassPermissions', max_turns=8, prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:gemini-agent', team_name=<위 team_name>, name='gemini-analyst', mode='bypassPermissions', max_turns=8, prompt='<role info>')",
