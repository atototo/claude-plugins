...
const instruction = [
  ...
  "   - Agent(subagent_type='ai-party:claude-agent', team_name=<위 team_name>, name='claude-architect', mode='bypassPermissions', prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:codex-agent', team_name=<위 team_name>, name='codex-builder', mode='bypassPermissions', prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:gemini-agent', team_name=<위 team_name>, name='gemini-analyst', mode='bypassPermissions', prompt='<role info>')",
