...
const result = {
  systemMessage: [
    ...
    "5. Task(subagent_type='ai-party:leader-agent', team_name=<위 team_name>, name='leader', prompt='<task + team info>')",
    "6. 팀 프리셋의 모든 worker 스폰: Task(subagent_type='ai-party:{agent}', team_name=<위 team_name>, name='{agent}-{role}', prompt='<role info>')",
    "7. Leader가 파이프라인을 관리한다. Host는 승인 게이트만 담당한다.",
    "",
