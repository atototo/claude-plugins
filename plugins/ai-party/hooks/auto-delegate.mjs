...
const instruction = [
  ...
  "   - Agent(subagent_type='ai-party:leader', team_name=<위 team_name>, name='leader', mode='bypassPermissions', model='opus', prompt='<아래 Leader prompt 규칙 참고>')",
  ...
  "   - Agent(subagent_type='ai-party:architect', team_name=<위 team_name>, name='architect', mode='bypassPermissions', model='opus', max_turns=15, prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:builder', team_name=<위 team_name>, name='builder', mode='bypassPermissions', model='sonnet', max_turns=8, prompt='<role info>')",
  "   - Agent(subagent_type='ai-party:analyst', team_name=<위 team_name>, name='analyst', mode='bypassPermissions', model='sonnet', max_turns=8, prompt='<role info>')",
