...
const TRANSITIONS = {
  ...
  [STATES.ANALYZING]: new Set([STATES.PLANNING, STATES.REVIEWING, STATES.AWAITING_APPROVAL]),
  [STATES.PLANNING]: new Set([STATES.EXECUTING, STATES.REVIEWING, STATES.AWAITING_APPROVAL]),
  [STATES.EXECUTING]: new Set([STATES.REVIEWING, STATES.AWAITING_APPROVAL]),
